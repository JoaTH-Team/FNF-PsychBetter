...
class LuaUtils
{
	...
	public static function setVarInArray(instance:Dynamic, variable:String, value:Dynamic, allowMaps:Bool = false):Any
	{
		...
		if(splitProps.length > 1)
		{
			...
			if(MusicBeatState.getState().variables.exists(splitProps[0]))
			{
				var retVal:Dynamic = MusicBeatState.getState().variables.get(splitProps[0]);
				if(retVal != null)
					target = retVal;
			}
		...
		if(MusicBeatState.getState().variables.exists(variable))
		{
			MusicBeatState.getState().variables.set(variable, value);
			return value;
		}
	...
	public static function getVarInArray(instance:Dynamic, variable:String, allowMaps:Bool = false):Any
	{
		...
		if(MusicBeatState.getState().variables.exists(variable))
		{
			var retVal:Dynamic = MusicBeatState.getState().variables.get(variable);
			if(retVal != null)
				return retVal;
		}
	...
	public static function getModSetting(saveTag:String, ?modName:String = null)
	{
		...
		else
		{
			...
			addTextToDebug('getModSetting: $path could not be found!', FlxColor.RED);
			#else
		...
		#if (LUA_ALLOWED || HSCRIPT_ALLOWED)
		addTextToDebug('getModSetting: "$saveTag" could not be found inside $modName\'s settings!', FlxColor.RED);
		#else
